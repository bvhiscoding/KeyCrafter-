/** Admin navigation items — defined outside render to avoid re-creation */
...
export const adminNav = [
  ...
  { to: "/admin/categories", label: "Categories", icon: <CatIcon /> },
  { to: "/admin/brands", label: "Brands", icon: <BrandIcon /> },
