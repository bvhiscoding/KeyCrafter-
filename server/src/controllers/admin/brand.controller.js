...
const getAllBrands = asyncHandler(async (req, res) => {
  const response = await brandService.getAllBrands(req.query);

  res
    .status(HTTP_STATUS.OK)
    .json(new ApiResponse(HTTP_STATUS.OK, response, 'Fetched admin brands'));
});
...
const updateBrand = asyncHandler(async (req, res) => {
  ...
  res
    .status(HTTP_STATUS.OK)
    .json(new ApiResponse(HTTP_STATUS.OK, response, 'Brand updated'));
});
...
const deleteBrand = asyncHandler(async (req, res) => {
  ...
  res
    .status(HTTP_STATUS.OK)
    .json(new ApiResponse(HTTP_STATUS.OK, response, 'Brand deleted'));
});
